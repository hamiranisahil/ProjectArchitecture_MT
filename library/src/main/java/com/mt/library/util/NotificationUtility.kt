...
//        builder.setContentIntent(pendingIntent)
    ...
    fun bigTextNotification(title: String, message: String, bigText: String, icon: Int) {
...
//
    ...
    fun customNotification(
        ...
        val builder = NotificationCompat.Builder(context, channelId).setPriority(Notification.PRIORITY_MAX)
