...
public class RecyclerViewDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public RecyclerViewDividerItemDecoration(Context context, int orientation, int leftMargin, int topMargin, int rightMargin, int bottomMargin) {
    ...
    public void drawHorizontal(Canvas c, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            mDivider.setBounds(left, top + dpToPx(topMargin), right, bottom - dpToPx(bottomMargin));
            mDivider.draw(c);
        }
    }
